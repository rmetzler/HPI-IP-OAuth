\subsection{OAuth Privacy EMail Service for HPIIP}
...
\includegraphics{../HPI-IP-OAuth/raw/master/example-service-seq.png}

\subsubsection{Implementing OAuth Privacy Service}
